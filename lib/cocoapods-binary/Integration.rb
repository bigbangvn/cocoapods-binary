    ...
    class Installer
        class PodSourceInstaller
            ...
            def install_for_prebuild!(standard_sanbox)
                # if standard_sanbox.local? self.name
    ...
    class Installer
        ...
        def remove_target_files_if_needed
            ...
            updated_names.each do |name|
                ...
                if self.sandbox.local?(root_name)
                    puts "Ignore root_name: #{root_name}"
                    next
                end
                ...
                UI.puts "remove tree: #{target_path}"
        ...
        define_method(:resolve_dependencies) do
            puts "swizzled resolve_dependencies"
